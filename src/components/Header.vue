<template>
  <header class="s-header">
    <div class="header-logo">
      <a href="index.html">
        <img
          src="https://www.styleshout.com/templates/preview/Ethos_1_0_0/images/logo.svg"
          alt="Homepage"
        >
      </a>
    </div>
      ...
      <nav class="row header-nav-wrap">
        <ul class="header-nav">
          <li :key="menu.id" v-for="menu in menus">
            <a class="smoothscroll" :href="menu.url" :title="menu.title">{{menu.text}}</a>
          </li>
        </ul>
      </nav>
      <!-- end header-nav-wrap -->
    ...
    <!-- end header-content -->
    <a @click="e => e.preventDefault()" class="header-menu-toggle" href="#0">
      <span>Menu</span>
    </a>
  </header>
</template>
